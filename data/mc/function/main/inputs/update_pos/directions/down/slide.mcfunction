...
$execute unless score #mc.slider.old_percent_y mc.data = #mc.slider.percent mc.data run function mc:main/gui/type/slider/action with entity @s data.interaction[{id:$(target_id)}].action[{type:slider}].direction.down
