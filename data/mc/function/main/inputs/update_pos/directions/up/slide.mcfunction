##direction check
execute if data storage mc:data temp.slide.direction{up:"none"} run return fail
...
scoreboard players operation #mc.gui.slide.total mc.data = #mc.gui.drag.temp mc.data
