...
execute if score #mc.gui.drag.temp mc.data <= #mc.gui.screen_bounds mc.data store result storage mc:data mouse.x float 0.001 run scoreboard players operation #mc.gui.drag.temp mc.data = #mc.gui.screen_bounds mc.data
